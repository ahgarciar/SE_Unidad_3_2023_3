...
archivo = open("instancia_Ejemplo_Completa.txt")
...
###PRUEBA DE LA FUNCIOANLIDA DEL ASOCIADOR LINEAL
...
#en este ejmplo los registros de prueba son los registros de entranmiento....
for i in range(X.shape[1]): #para cada uno de los casos/registros de prueba
    ...
    Ycasoi = W.dot(casoi) #Pesos * entradas
